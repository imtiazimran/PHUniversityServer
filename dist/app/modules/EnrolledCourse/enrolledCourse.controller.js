...
const getAllEnrolledCourses = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const facultyId = req.user.userId;
    const result = yield enrolledCourse_service_1.EnrolledCourseServices.getAllEnrolledCoursesFromDB(facultyId, req.query);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
